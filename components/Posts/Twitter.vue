...
const { socialAccount, post, isSelectable = false } = props;
...
<template>
  <div
    v-if="post"
    class="bg-white dark:bg-gray-800 dark:border-gray-800 p-4 rounded-xl border"
    :class="{
  ...
  >
    ...
    <p class="text-gray-500 dark:text-gray-400 text-base py-1 my-0.5">
      {{ twitterPostFormatDate(post?.postAt) }}
    </p>
    <div
    ...
    <div class="text-gray-500 dark:text-gray-400 flex mt-3">
      ...
      <div class="flex items-center mr-6">
        ...
        <span class="ml-3">22 people are Tweeting about this</span>
      </div>
    </div>
  </div>
</template>
